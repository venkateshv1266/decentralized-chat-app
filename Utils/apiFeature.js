//all general functions which we need in application... These functions are common for communicating with 
//smart contracts. Hence we can reuse these functions
...
export const convertTime = (time) => {
    ...
    const realTime = "Time: " + newTime.getHours() + ":" + newTime.getMinutes() +
