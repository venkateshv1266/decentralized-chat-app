          ...
          <div className={Style.Navbar_box_right_connect}>
            {account == "" ? (
              ...
              <button onClick={() => setOpenModel(true)}>
                {""}
                <Image src={userName != "Create Account" ? images.accountName : images.create2} alt='Account image' width={20} height={20} />
                {""}
      ...
      {openModel && (
        <div className={Style.modelBox}>
          <Model
            ...
            title="WELCOME TO"
            head="CHAT BUDDY"
            info="Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur a ipsum quasi, deleniti hic, fugit autem magnam, necessitatibus sed eius odio eveniet obcaecati veritatis beatae quas aliquam dolores iste et?"
